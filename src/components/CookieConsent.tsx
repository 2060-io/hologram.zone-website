...
export default function CookieConsent() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-neutral-200 dark:border-white/10 bg-white/95 dark:bg-neutral-950/95 backdrop-blur shadow-[0_-8px_24px_-12px_rgba(0,0,0,0.25)]"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col gap-4 md:flex-row md:items-center md:gap-6">
        <div className="flex-1 text-sm leading-relaxed">
          <p
            id="cookie-consent-title"
            className="font-display text-base font-semibold text-neutral-900 dark:text-white mb-1"
          >
            Cookies
          </p>
          <p id="cookie-consent-body" className="text-neutral-600 dark:text-neutral-400">
            We use Google Analytics to understand, at an aggregate level, how this site is used. Nothing is loaded until you choose. See our{" "}
            <Link href="/cookies" className="underline decoration-dotted hover:text-neutral-900 dark:hover:text-white">
              cookie policy
            </Link>{" "}
            for details.
          </p>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-sm font-semibold border border-neutral-300 dark:border-white/15 text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-white/5 transition"
          >
            Cancel
          </button>
          <button
