  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="flex flex-col items-center">
              <Image src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Google Play" width={100} height={100} className="mt-2" />
                <a href="https://play.google.com/store/apps/details?id=com.myapp" className="text-green-500 hover:underline font-bold py-3 px-6 transition-colors duration-300">
                  Google Play
                </a>
            </div>
            ...
            <div className="flex flex-col items-center">
              <Image src="https://developer.apple.com/app-store/marketing/guidelines/images/badge-download-on-the-app-store.svg" alt="App Store" width={100} height={100} className="mt-2" />
                <a href="https://apps.apple.com/us/app/myapp/id12345678" className="text-green-500 hover:underline font-bold py-3 px-6 transition-colors duration-300">
                  App Store
                </a>
            </div>
            ...
            <div className="flex flex-col items-center">
              <Image src="data:image/svg+xml;base64," alt="Huawei AppGallery" width={100} height={100} className="mt-2" />
                <a href="https://appgallery.huawei.com/app/C12345678" className="text-green-500 hover:underline font-bold py-3 px-6 transition-colors duration-300">
                  App Gallery
                </a>
            </div>
          </div>
      ...
      {oobData && deviceType === 'mobile' && (
        <section className="container mx-auto my-8 md:my-12 lg:my-16 flex flex-col items-center justify-center text-center">
            <a href={`didcomm://aries_proof-request?${searchParams}`} className="text-green-500 hover:underline font-bold py-3 px-6 transition-colors duration-300">
