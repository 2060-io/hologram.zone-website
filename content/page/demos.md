...
{{< demo-section
    ...
    background="bg-white"
    reverse="false"
    kicker_text="Credential Issuer"
    kicker_icon="fa-solid fa-id-badge"
    kicker_class="bg-violet-100 text-violet-700"
    title="Avatar"
    title_icon="fa-solid fa-user-shield"
    title_icon_color="text-hologram-primary"
    description="A DIDComm chatbot that issues **verifiable credentials** to users through conversational interactions. Connect with Hologram Messaging, follow the guided flow, and receive a **Verifiable Credential** backed by the Verana Trust Registry. Your credential proves attributes about you and can be verified by any party."
    primary_label="Try the Demo"
    primary_url="https://avatar.vs.hologram.zone/invitation"
    primary_icon="fa-solid fa-play"
    primary_class="inline-flex items-center justify-center px-6 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-sm bg-hologram-primary text-white hover:bg-hologram-secondary"
    secondary_label="Learn More"
    secondary_url="/page/avatar"
    secondary_icon="fa-solid fa-arrow-right"
    secondary_class="inline-flex items-center justify-center px-6 py-3 rounded-lg font-semibold transition-colors duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200"
    image_src="/images/avatar-service.webp"
    image_alt="Avatar credential issuer chatbot interface in Hologram Messaging."
    image_gradient_class="from-violet-100 to-hologram-primary/10"
>}}
{{< /demo-section >}}
{{< demo-section
